        ...
        <>
            ...
            <div className="flex flex-col med:flex-row items-center justify-between p-8 bg-gray-100 px-8 py-10">
                <div className="mb-20 med:w-1/2 px-8">
                    ...
                    <ul className="list-disc list-inside text-gray-700 font-medium text-lg space-y-2">
                        <li>Custom bathroom designs.</li>
                        <li>Modern showers and tubs.</li>
                        <li>Vanity and sink upgrades.</li>
                        <li>Tile and flooring installation.</li>
                        <li>Enhanced lighting and ventilation.</li>
                    </ul>
            ...
            <div className="p-10 bg-slate-300">
                <p className="text-center mt-2 text-gray-700 leading-relaxed mx-auto text-lg">
                    Check out our recent bathroom remodel, where we transformed it into a stylish and functional oasis that reflects our dedication to quality and detail!
                </p>
