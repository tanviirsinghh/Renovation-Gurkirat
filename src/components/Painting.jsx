        ...
        <>
            ...
            <div className="flex flex-col med:flex-row items-center justify-between p-8 bg-gray-100 px-8 py-10">
                <div className="mb-20 med:w-1/2 px-8">
                    <h1 className="text-4xl font-bold text-gray-800 mb-6">Enhance Your Space with Professional Painting Services!</h1>
                    <h2 className="font-sans font-medium text-lg text-gray-700 mb-6 leading-relaxed text-justify">
                        GD Renovation & Contracting offers top-tier painting services to elevate the look of your entire home. From accent walls to full interior and exterior transformations, our team delivers flawless finishes using high-quality paints that last.
                    </h2>
                    <h3 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Our Painting Services Include:</h3>
                    <ul className="list-disc list-inside text-gray-700 font-medium text-lg space-y-2">
                        <li>Interior Painting - Refresh your interiors with colors that bring warmth and style.</li>
                        <li>Exterior Painting - Increase curb appeal with durable, weather-resistant finishes.</li>
                        <li>Accent Walls - Personalize your space with stunning custom feature walls.</li>
                        <li>Surface Preparation - Complete cleaning, repairing, and priming for a smooth result.</li>
                        <li>Eco-Friendly Products - We prioritize high-quality, environmentally safe paints for beautiful, lasting results.</li>
                    </ul>
                    <h3 className="text-2xl font-semibold text-gray-800 mt-8">Let's Bring New Life to Your Space!</h3>
                </div>
                <div className="med:w-1/2">
                    <img
                        src={img}
                        alt="Home Painting"
                        className="rounded-lg shadow-lg w-full h-auto object-cover bg-black opacity-90"
                    />
                </div>
            </div>
            <div className="p-10 bg-slate-400">
                <p className="text-center mt-2 text-gray-700 leading-relaxed mx-auto text-lg">
                    Discover our latest painting project, revitalizing spaces with fresh colors and finishes that highlight our dedication to quality and style!
                </p>
